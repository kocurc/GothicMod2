...
//-------Banditen----------------
const string Topic_Addon_Logan		= "Polowanie na b�otne w�e";	
...
const string Topic_Addon_Fisk		= "Paczka pe�na wytrych�w";
const string Topic_Addon_Buddler	= "Trzy kamienie � trzech kopaczy";
const string Topic_Addon_Tempel		= "Doj�cie do �wi�tyni";
...
// ------ Kapitel 1 ------
CONST string 	Topic_Bandits				=	"Listy go�cze"; 

// ------ Der R�benbauer ------
const string	TOPIC_Kleidung				=	"Ubi�r roboczy Lobarta";
const string	TOPIC_Rueben				=	"Zebra� rzep� z pola";
const string	TOPIC_Ruebenbringen			=	"Zanie�� rzepy Hildzie";
const string	TOPIC_Vino					=	"Za buletk� wina";
const string	TOPIC_Maleth				=	"Bandyci na farmie Lobarta";
const string	TOPIC_Hilda					=	"Patelnia dla Hildy";

//-----Der Weg in die Stadt-------------
const string	TOPIC_City					=	"Jak si� dosta� do miasta Khorinis";
...
const string	TOPIC_OV					=   "Dosta� si� do g�rnego miasta";

const string	TOPIC_Matteo				=   "Matteo i Gritta";
const string	TOPIC_Thorben				=   "B�ogos�awie�stwo bog�w";
...
//-------------H�ndler und Diebe---------------------------
const string	TOPIC_Canthar				=	"Wzgl�dy Canthara";
...
const string 	Topic_CassiaRing			= 	"Pier�cie� Constantina";
...
const string	Topic_Kloster				=	"Jak si� dosta� do klasztoru";
const string    Topic_Gemeinschaft			=	"S�u�ba spo�eczno�ci";

//---------Arbeiten f�r die Gemeinschaft-----------------------------
const string    Topic_Neorasrezept  		=	"Zaginiony przepis";
const string    Topic_NeorasPflanzen		=	"Siedem zi�";
...
const string	TOPIC_Schnitzeljagd			=	"�cie�ka Wiernych"; 
...
const string	TOPIC_TorlofPacht			=	"Zebra� czynsz";
const string	TOPIC_TorlofMiliz			=	"Odp�dzi� stra�";
...
const string 	Topic_CipherHerb			=	"Za kilka zi� wi�cej";    
...
const string 	TOPIC_KickBullco			=	"Skopa� ty�ek Bullkowi"; 
...
const string	TOPIC_RescueGorn			=	"Uratowa� Gorna";
const string	TOPIC_FajethKillSnapper		=	"Polowanie na z�bacze";
const string	TOPIC_BringMeat				=	"Mi�so";
const string	TopicBrutusKasse			=	"Z�oto dla Brutusa";

const string	Topic_TengronRing			=	"Pier�cie� Tengrona";
const string	Topic_OricBruder			=	"Z�e wie�ci";

const string	TOPIC_BilgotEscort			=	"Kl�twa Bilgota";

const string	TOPIC_Botschaft				=	"Wiadomo��";
const string	TOPIC_Lutero				=	"Pazury z�bacza";
const string	TOPIC_Fernando				=	"Sprawa Fernanda";

//-------------------------------------------------------------------------------------
const string	TOPIC_PyrokarClearDemonTower	 = "Powr�t do wie�y";
const string	TOPIC_HyglasBringBook			 = "Pot�ga Gwiazd";
